...
export const msalConfig: Configuration = {
    auth: {
        clientId: 'd1e80f09-6d36-49e9-a9bf-227bb1ced7ac', // This is the ONLY mandatory field that you need to supply.
 ...
 */
 export const protectedResources = {
  apiTodoList: {
      endpoint: "https://localhost:6001/api/v1",
      scopes: {
          read: ["https://TGCIdentityService.onmicrosoft.com/expenses-api/operation.read"]//,
          //write: ["https://fabrikamb2c.onmicrosoft.com/TodoList/ToDoList.ReadWrite"]
      }
  }
//   apiExpenseGroup : {
//     endpoint: "https://localhost:6001/api/v1/ExpenseGroup",
//       scopes: {
//           read: ["https://TGCIdentityService.onmicrosoft.com/expenses-api/operation.read"]//,
//           //write: ["https://fabrikamb2c.onmicrosoft.com/TodoList/ToDoList.ReadWrite"]
//       }
